...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://{}:{}@{}/{}".format(
            'postgres', '1366', 'localhost:5432', self.database_name)
    ...
    def test_405_retrieve_categories(self):
    ...
    def test_create_wrong_question_format(self):
        new_question = {
            'question': 'who is not in the cage?',
            'answer': '',
            'difficulty': 2,
            'category': '2',
        }
    ...
    def test_get_questions_search_without_results(self):
        res = self.client().post('/search',
                                 json={'searchTerm': 'dawdsdawdsdawd'})
        data = json.loads(res.data)
    ...
    def test_400_question_by_category(self):
